...
namespace LeaveManagementWebAPI.Controllers
{
    ...
    {
        DepartementTypeRepository _repository;

        public DepartementTypeController(DepartementTypeRepository repository)
        {
        ...
        // UPDATE 
        [HttpPut("{id}")]
        public IActionResult Put(int id, DepartementTypeViewModel departementType)
        {
            var result = _repository.Put(id, departementType);
            if (result > 0)
        ...
        // CREATE
        [HttpPost]
        public IActionResult Post(DepartementTypeViewModel departementType)
        {
            var result = _repository.Post(departementType);
            if (result > 0)
